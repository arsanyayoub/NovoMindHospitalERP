...
public class PharmacyService : IPharmacyService
{
    ...
    public async Task<PagedResult<PrescriptionDto>> GetPrescriptionsAsync(PagedRequest request, string? status)
    {
    ...
    public async Task<PrescriptionDto> CreatePrescriptionAsync(CreatePrescriptionDto dto, string createdBy)
    {
    ...
    public async Task CancelPrescriptionAsync(int id, string updatedBy)
    {
    ...
    internal static PrescriptionDto ToDto(Prescription p)
    {
        return new PrescriptionDto(
            ...
            p.AppointmentId, p.PrescriptionDate, p.Status, p.Notes,
