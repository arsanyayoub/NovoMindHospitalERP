...
var AppComponent = class _AppComponent {
  ...
  static {
    this.\u0275fac = function AppComponent_Factory(t) {
      return new (t || _AppComponent)(\u0275\u0275directiveInject(TranslateService), \u0275\u0275directiveInject(LanguageService));
    };
  }
  static {
...
var routes = [
  {
    ...
    children: [
      {
        path: "login",
        loadComponent: () => import("./chunk-STJBVK3I.js").then((m) => m.LoginComponent)
      }
    ]
  },
  {
    path: "",
    loadComponent: () => import("./chunk-VW2C4IEE.js").then((m) => m.ShellComponent),
    canActivate: [authGuard],
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-Q4B5SXTB.js").then((m) => m.DashboardComponent)
      },
      {
        path: "patients",
        loadComponent: () => import("./chunk-I6QDHA4N.js").then((m) => m.PatientsComponent)
      },
      {
        path: "invoices",
        loadComponent: () => import("./chunk-UO6RJZ3C.js").then((m) => m.InvoicesComponent)
      },
      {
        path: "doctors",
        loadComponent: () => import("./chunk-SQQXWSW7.js").then((m) => m.DoctorsComponent)
      },
      {
        path: "appointments",
        loadComponent: () => import("./chunk-MAOWDOOM.js").then((m) => m.AppointmentsComponent)
      },
      {
        path: "accounting",
        loadComponent: () => import("./chunk-25Q3LU2T.js").then((m) => m.AccountingComponent)
      },
      {
        path: "inventory",
        loadComponent: () => import("./chunk-PNWUWA5B.js").then((m) => m.InventoryComponent)
      },
      {
        path: "purchases",
        loadComponent: () => import("./chunk-JAFOBXID.js").then((m) => m.PurchasesComponent)
      },
      {
        path: "sales",
        loadComponent: () => import("./chunk-CMQQJJL7.js").then((m) => m.SalesComponent)
      },
      {
        path: "hr",
        loadComponent: () => import("./chunk-FSW4FFZ3.js").then((m) => m.HrComponent)
      }
    ]
  },
...
var authInterceptor = (req, next) => {
  const auth = inject(AuthService);
  const router = inject(Router);
  const addToken = (request, token) => request.clone({ setHeaders: { Authorization: `Bearer ${token}` } });
  if (auth.token)
    req = addToken(req, auth.token);
  return next(req).pipe(catchError((error) => {
    if (error.status === 401 && auth.currentUser?.refreshToken) {
      return auth.refreshToken().pipe(switchMap((res) => next(addToken(req, res.accessToken))), catchError(() => {
        auth.logout();
