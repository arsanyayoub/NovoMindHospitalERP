...
var NotificationService = class _NotificationService {
  ...
  startConnection() {
    if (!this.auth.token)
      return;
    this.hubConnection = new HubConnectionBuilder().withUrl(`${environment.hubUrl}/hubs/notifications`, {
    ...
    this.hubConnection.on("AppointmentCreated", (data) => console.log("Appointment created:", data));
    this.hubConnection.on("InvoiceCreated", (data) => console.log("Invoice created:", data));
    this.hubConnection.on("PaymentReceived", (data) => console.log("Payment received:", data));
    this.hubConnection.on("StockUpdated", (data) => console.log("Stock updated:", data));
  ...
  loadNotifications() {
    return this.http.get(this.API).pipe(tap((n) => this.notificationsSubject.next(n)));
  }
  getUnreadCount() {
    return this.http.get(`${this.API}/unread-count`).pipe(tap((r) => this.unreadCountSubject.next(r.count)));
  }
  markAsRead(id) {
    return this.http.post(`${this.API}/${id}/read`, {}).pipe(tap(() => {
      const updated = this.notificationsSubject.value.map((n) => n.id === id ? __spreadProps(__spreadValues({}, n), { isRead: true }) : n);
  ...
  markAllAsRead() {
    return this.http.post(`${this.API}/read-all`, {}).pipe(tap(() => {
      const updated = this.notificationsSubject.value.map((n) => __spreadProps(__spreadValues({}, n), { isRead: true }));
      this.notificationsSubject.next(updated);
...
function ShellComponent_span_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 1, "APP_NAME"));
  }
}
function ShellComponent_a_6_span_4_Template(rf, ctx) {
  if (rf & 1) {
...
function ShellComponent_a_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, ShellComponent_a_6_span_4_Template, 3, 3, "span", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r1 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", item_r1.route)("title", \u0275\u0275pipeBind1(1, 4, item_r1.label));
    \u0275\u0275advance(3);
...
function ShellComponent_span_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 30);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 1, "LOGOUT"));
  }
}
function ShellComponent_span_33_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", count_r3 > 9 ? "9+" : count_r3, " ");
  }
}
function ShellComponent_div_37_div_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 38);
    \u0275\u0275listener("click", function ShellComponent_div_37_div_9_Template_div_click_0_listener() {
      const n_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.readNotif(n_r6));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("unread", !n_r6.isRead);
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx_r1.getNotifClass(n_r6.notificationType));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getNotifIcon(n_r6.notificationType), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(n_r6.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(n_r6.message);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(10, 7, n_r6.createdDate, "short"));
  }
}
function ShellComponent_div_37_div_11_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 1, "NO_NOTIFICATIONS"));
  }
}
function ShellComponent_div_37_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 32);
    \u0275\u0275listener("click", function ShellComponent_div_37_Template_div_click_0_listener($event) {
      \u0275\u0275restoreView(_r4);
    ...
    \u0275\u0275listener("click", function ShellComponent_div_37_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(9, ShellComponent_div_37_div_9_Template, 11, 10, "div", 36);
    \u0275\u0275pipe(10, "async");
    \u0275\u0275template(11, ShellComponent_div_37_div_11_Template, 6, 3, "div", 37);
    \u0275\u0275pipe(12, "async");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 4, "NOTIFICATIONS"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 6, "MARK_ALL_READ"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(10, 8, ctx_r1.notificationService.notifications$));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ((tmp_4_0 = \u0275\u0275pipeBind1(12, 10, ctx_r1.notificationService.notifications$)) == null ? null : tmp_4_0.length) === 0);
  }
}
function ShellComponent_div_41_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 46)(1, "span", 14);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ShellComponent_div_41_Template_button_click_5_listener() {
      const t_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toastService.remove(t_r8.id));
    });
    \u0275\u0275text(6, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", t_r8.type);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(t_r8.type === "success" ? "check_circle" : t_r8.type === "error" ? "error" : "info");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(t_r8.message);
  }
}
var ShellComponent = class _ShellComponent {
  constructor(auth, notificationService, langService, toastService) {
    this.auth = auth;
  ...
  static {
    this.\u0275fac = function ShellComponent_Factory(t) {
      return new (t || _ShellComponent)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(NotificationService), \u0275\u0275directiveInject(LanguageService), \u0275\u0275directiveInject(ToastService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ShellComponent, selectors: [["app-shell"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 42, vars: 19, consts: [[1, "sidebar"], [1, "sidebar-brand"], [1, "material-icons-round", "brand-icon"], ["class", "brand-text", 4, "ngIf"], [1, "sidebar-nav"], ["routerLinkActive", "active", "class", "nav-item", 3, "routerLink", "title", 4, "ngFor", "ngForOf"], [1, "sidebar-footer"], [1, "nav-item", 3, "click"], [1, "material-icons-round", "nav-icon"], ["class", "nav-label", 4, "ngIf"], [1, "main-wrapper"], [1, "top-header"], [1, "header-left"], [1, "btn-icon", "toggle-btn", 3, "click"], [1, "material-icons-round"], [1, "welcome-text"], [1, "text-muted", "text-sm"], [1, "font-semibold"], [1, "header-right"], ["title", "Toggle Language", 1, "header-btn", 3, "click"], [1, "btn-label"], [1, "header-btn", "notification-btn", 3, "click"], ["class", "notif-badge", 4, "ngIf"], [1, "user-avatar"], ["class", "notification-panel", 3, "click", 4, "ngIf"], [1, "page-content"], [1, "toast-container"], ["class", "toast", 3, "ngClass", 4, "ngFor", "ngForOf"], [1, "brand-text"], ["routerLinkActive", "active", 1, "nav-item", 3, "routerLink", "title"], [1, "nav-label"], [1, "notif-badge"], [1, "notification-panel", 3, "click"], [1, "notif-header"], [1, "btn", "btn-sm", "btn-secondary", 3, "click"], [1, "notif-list"], ["class", "notif-item", 3, "unread", "click", 4, "ngFor", "ngForOf"], ["class", "empty-state", 4, "ngIf"], [1, "notif-item", 3, "click"], [1, "material-icons-round", "notif-type-icon", 3, "ngClass"], [1, "notif-content"], [1, "notif-title"], [1, "notif-msg"], [1, "notif-time"], [1, "empty-state"], [1, "material-icons-round", "empty-icon"], [1, "toast", 3, "ngClass"], [1, "toast-close", 3, "click"]], template: function ShellComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "aside", 0)(1, "div", 1)(2, "span", 2);
        \u0275\u0275text(3, "local_hospital");
        \u0275\u0275elementEnd();
        \u0275\u0275template(4, ShellComponent_span_4_Template, 3, 3, "span", 3);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(5, "nav", 4);
        \u0275\u0275template(6, ShellComponent_a_6_Template, 5, 6, "a", 5);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(10, "logout");
        \u0275\u0275elementEnd();
        \u0275\u0275template(11, ShellComponent_span_11_Template, 3, 3, "span", 9);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(12, "div", 10)(13, "header", 11)(14, "div", 12)(15, "button", 13);
        \u0275\u0275listener("click", function ShellComponent_Template_button_click_15_listener() {
        ...
        \u0275\u0275listener("click", function ShellComponent_Template_button_click_25_listener() {
        ...
        \u0275\u0275listener("click", function ShellComponent_Template_button_click_30_listener() {
          return ctx.showNotifications = !ctx.showNotifications;
        });
        \u0275\u0275elementStart(31, "span", 14);
        \u0275\u0275text(32, "notifications");
        \u0275\u0275elementEnd();
        \u0275\u0275template(33, ShellComponent_span_33_Template, 2, 1, "span", 22);
        \u0275\u0275pipe(34, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(35, "div", 23);
        \u0275\u0275text(36);
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(37, ShellComponent_div_37_Template, 13, 12, "div", 24);
        \u0275\u0275elementStart(38, "main", 25);
        \u0275\u0275element(39, "router-outlet");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(40, "div", 26);
        \u0275\u0275template(41, ShellComponent_div_41_Template, 7, 3, "div", 27);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
