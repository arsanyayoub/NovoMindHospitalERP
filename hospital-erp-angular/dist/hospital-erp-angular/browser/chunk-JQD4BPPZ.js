...
var AuthService = class _AuthService {
  ...
  login(dto) {
    return this.http.post(`${this.API}/login`, dto).pipe(tap((res) => {
      localStorage.setItem("auth_user", JSON.stringify(res));
      this.currentUserSubject.next(res);
    }));
  }
  register(dto) {
    return this.http.post(`${this.API}/register`, dto).pipe(tap((res) => {
      localStorage.setItem("auth_user", JSON.stringify(res));
      this.currentUserSubject.next(res);
    }));
  }
  refreshToken() {
    ...
    return this.http.post(`${this.API}/refresh-token`, { refreshToken }).pipe(tap((res) => {
      localStorage.setItem("auth_user", JSON.stringify(res));
      this.currentUserSubject.next(res);
    }));
  }
  ...
  getStoredUser() {
    try {
      ...
      if (new Date(user.expiry) <= /* @__PURE__ */ new Date()) {
        localStorage.removeItem("auth_user");
        return null;
      }
      return user;
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-JQD4BPPZ.js.map
